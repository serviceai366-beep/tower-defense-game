...
const I18N = (() => {
    ...
    const exact = {
        ...
        'МАШИНА ЗАПУЩЕНА': 'VEHICLE LAUNCHED',
    ...
    const phrase = [
        ...
        ['Нажми кнопку — бронемашина сразу выедет из базы и поедет навстречу волне.', 'Press the button and the armored car immediately leaves the base into the wave.'],
        ['ЗАПУСТИТЬ МАШИНУ', 'LAUNCH VEHICLE'],
