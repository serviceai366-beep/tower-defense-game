...
const TOWER_TYPES = {
    ...
    djBooth: {
        name: 'Диджейский пульт', icon: '🎛', description: 'Усиливает все постройки в радиусе: урон, HP, дальность и доход',
        cost: 325, damage: 0, range: 135, fireRate: 999, hp: 145, unlockWave: 5,
        isDjBooth: true,
        footprint: [{ x: 0, y: 0 }, { x: 1, y: 0 }],
        buffPercent: 0.05,
        baseColor: '#581c87', turretColor: '#7c3aed', barrelColor: '#22d3ee',
        projectileColor: '#c084fc', projectileSize: 0, isAoe: false, chainTargets: 0,
        buildTime: 5.0, upgradeTimes: [3.5, 5.0],
        upgrades: [
            { cost: 230, range: 155, hp: 185, buffPercent: 0.10 },
            { cost: 360, range: 180, hp: 230, buffPercent: 0.15 },
        ],
    },
};
